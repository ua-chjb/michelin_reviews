...
def callbacks_baby(app):
    ...
    def again(on):
        if on is True:
            ...
            return fig_l_func(michelin, dataframe), pie_g_i_k_m_n(pie_gb(dataframe, "Award"), "Award", sort=False, textposition=None, title="Awards, subset")
        else:
            return fig_l_func(michelin, michelin), pie_g_i_k_m_n(pie_gb(michelin, "Award"), "Award", sort=False, textposition=None, title="Awards, subset")
    ...
    # )
    # def sothen_this_happens(data):
    #     if data:
    #         dataframe = pd.read_json(data)
    #         return pie_g_i_k_m_n(pie_gb(dataframe, "Award"), "Award", sort=False, textposition=None, title="awards, filtered"), fig_l_func(dataframe, michelin)
    #     else:
    #         return pie_g_i_k_m_n(pie_gb(michelin, "Award"), "Award", sort=False, textposition=None, title="awards, filtered"), fig_l_func(michelin, michelin)            



################################### dcc store again did not work ##############3333
# def callbacks_baby(app):
#     @app.callback(
...
#                 flag = 0
#                 no_mask = (data1["noshoes"] > flag)
#                 return data1[no_mask].to_json()
#             else:
#                 print("it should be changing the flag")
#                 data1=pd.read_json(data)
#                 flag = -1
#                 yes_mask = (data1["noshoes"] > flag)
#                 print(data1[yes_mask][:5])
#                 return data1[yes_mask].to_json()
#         else:
#             print("the store is loaded up")
#             return michelin.to_json()        
#     @app.callback(
#             Output(component_id="fig_m", component_property="figure"),
#             Output(component_id="fig_l", component_property="figure"),
#             Input(component_id="mdstore", component_property="data")
...
#             )
#     def so_what_happens(on1, on2, on3, data):
#         if data:
#             if on1:
#                 data1 = pd.DataFrame(data)
#                 print(data1[:5])
#                 flag = 0
#                 mask = (data1["noshoes"] > flag)
#                 return data1[mask].to_dict()
#             elif not on1:
#                 data1 = pd.DataFrame(data)
#                 flag = -1
#                 mask = (data1["noshoes"] > flag)
...
#                 return data1[mask].to_dict()
#         else:
#             print("data is passed to MDStore")
#             return michelin.to_dict()
...
###################################### I do not understsand why this does not work

# def callbacks_baby(app):
#     @app.callback(
#             Output("mdstore", "data", allow_duplicate=True),
#             Input("mdstore", "data"),
#             prevent_initial_call='initial_duplicate'
#     )
#     def firstly(data):
#         if type(data) is None:
#             print("mdstore loaded up")
#             return michelin.to_json()
...
#             prevent_initial_call='initial_duplicate'
#             )
#     def so_what_happens(on1, on2, on3, on4, on5, on6, on7, on8, on9, on10, on11, on12, on13, data):
#         if data:
#             if on1:
#                 data1 = pd.read_json(data)
#                 flag = 0
#                 mask = (data1["ac"] > flag)
#                 return data1[mask].to_json()
#             elif not on1:
#                 data1 = pd.read_json(data)
#                 flag = -1
#                 mask = (data1["ac"] > flag)
...
##################################################################### end confused section ###########################################33

        #     if on1:
        #         data1 = pd.read_json(data)
        #         ac_flag = 0
        #         mask_ac = (data1["ac"] > ac_flag)
...
#     def update_table(data):
    ...
    #         mask_ac = ( data1["ac"] > ac_flag)
    #         return data1[mask_ac].to_json()
    #         else:  # this case should never happen, but kept for organization
    #             data1 = pd.read_json(data)
    #             ac_flag = 0
    #             mask_ac = ( data1["ac"] > ac_flag )
    #             return data1[mask_ac].to_json()
...
#             0
    ...
    #     [Input(component_id="mdstore", component_property="data"),
    #     # Input(component_id="mdstore", component_property="data") # this would be the function input?
    #     ],
